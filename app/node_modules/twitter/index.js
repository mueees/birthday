var T = require("./twitterSteram").T, // twitter constructor
    ...
    convertingTweet = require('./converting'),
...
var opts = {
    ...
    defaultStream: {
        /*track: [
            'javascript', 'nodejs', 'css', 'CSS', 'CSS3', 'ExpressJS', 'Angular', 'Backbone', 'JavaScript',
            'HTML5', 'html5', 'npm', 'node.js'],*/
        track: 'MySQL, MongoDB, web development, webdev, WebSocket, HTML5Rocks,  javascript, nodejs, css3, ExpressJS, Angular, Backbone, html5, npm'
    }
}
...
Twitter.prototype = {
    ...
    getNewTweet: function(tweet){
        ...
        */
        ...
        //конвертируем твит в нужный формат

        tweet = convertingTweet(tweet);
