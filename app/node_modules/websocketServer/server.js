...
WebSocketServer.prototype = {
    ...
    onConnection: function(conn){
        ...
        var _this = this;
        this.connection.push( new Conn(conn));
    ...
    onData: function( message, conn ){
        ...
        if( data.id ){
            if( data.method ){
                ...
                this.crossroads.parse( req.method, [req]  );
...
<<<<<<< HEAD
        ...
        return req;
=======
        return new Request(data.method, data.params, data.id, conn);
>>>>>>> d78615a1f683a9cc2b82c98a88163c1cf69504bd
    },

    onCloseConn: function(){},

    publish: function(message){
        if( !this.connection.length ) return false;

        var i, max = this.listeners.length;
        for( i = 0; i < max; i++ ){
            this.connection[i].write( message );
        }
    },
